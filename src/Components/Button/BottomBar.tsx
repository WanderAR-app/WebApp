    ...
    if (page === SelectedPage) {
      return (
        <div className="botbardiv">
          <button
            className="BottomBarButtonSelected"
            onClick={() => {
              navigate("/home");
            }}
          >
          ...
          <div className="BottomBarTextSelected">{page}</div>
        </div>
      );
    } else {
      return (
        <div className="botbardiv">
          <button
            className="BottomBarButtonUnselected"
            onClick={() => {
              navigate("/setting");
            }}
          >
          ...
          <div className="BottomBarTextUnselected">{page}</div>
        </div>
      );
    }
  };
